...
class InputFeatures(object):
    ...
    def __init__(self, text_a_id, text_b_id, input_sents, input_mask, segment_ids, subtype_ids, label_id):
        self.text_a_id = text_a_id
        self.text_b_id = text_b_id
...
def write_instance_to_example_files(instances, output_files):
    ...
    for (inst_index, instance) in enumerate(instances):
        ...
        features["subtype_ids"] = create_int_feature(instance.subtype_ids)
        ...
        # 	print("input_sents: %s" % " ".join([str(tokenization.printable_text(x)) for x in instance.input_sents]))
